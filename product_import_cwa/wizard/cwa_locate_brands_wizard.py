...
class CwaProductImportBrands(models.TransientModel):
    ...
    brand_ids = fields.One2many(
        'cwa.product.brands.wizard', 'wizard_id', string='Product Brands',
...
class CwaProductBrandsWizard(models.TransientModel):
    ...
    wizard_id = fields.Many2one(
        'cwa.product.import.brands', string='Wizard', required=True,
        ondelete='cascade')
