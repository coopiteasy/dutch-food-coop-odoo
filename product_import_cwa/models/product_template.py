...
class ProductTemplate(models.Model):
    ...
    proefdiervrij = fields.Selection(
        related='preferred_supplier_id.proefdiervrij')
    ...
    plucode = fields.Char(related='preferred_supplier_id.plucode', help="4-cijferige plucode.")
    ...
    bewaartemperatuur = fields.Char(
        related='preferred_supplier_id.bewaartemperatuur',
        help="Bewaartemperatuur.")
    gebruikstips = fields.Char(
        related='preferred_supplier_id.gebruikstips',
        help="Gebruikstips.")
    verpakkingce = fields.Char(related='preferred_supplier_id.verpakkingce', help="Verpakking van consumenteneenheid.")
