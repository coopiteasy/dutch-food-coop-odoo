...
class ResConfigSettings(models.TransientModel):
    ...
    weighted_barcode_rule_id = fields.Many2one("barcode.rule", string="Barcode Rule for Weighted products")
    piece_barcode_rule_id = fields.Many2one("barcode.rule", string="Barcode Rule for Piece products")
    ...
    def get_values(self):
        ...
        res.update(
            ...
            weighted_barcode_rule_id=int(weighted_barcode_rule_id) if weighted_barcode_rule_id else False,
            piece_barcode_rule_id=int(piece_barcode_rule_id) if piece_barcode_rule_id else False,
        )
        return res
    ...
    def set_values(self):
        ...
        configuration.set_param("weighted_barcode_rule_id", self.weighted_barcode_rule_id.id)
